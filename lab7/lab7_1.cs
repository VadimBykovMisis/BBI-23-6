...
public class Program
{
    ...
    public abstract class Survey
    {
        ...
        public abstract void RunSurvey();
    }
    public class ManOfTheYear : Survey
    {
        public override void RunSurvey()
        {
            Console.WriteLine("Результаты опроса 'Человек года: '");
            this.ShowResult();
        }
    }
    public class OpeningOfTheYear : Survey
    {
        public override void RunSurvey()
        {
            Console.WriteLine("Результаты опроса 'Открытие года: '");
            this.ShowResult();
        }
    }
        public static void Main(string[] args)
    {
        Survey a = new ManOfTheYear();
        a.AddAnswer("Быков");
        a.AddAnswer("Быков");
        a.AddAnswer("Быков");
        a.AddAnswer("Быков");
